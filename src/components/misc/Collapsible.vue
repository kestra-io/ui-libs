<template>
    <div :id="href" class="d-flex flex-column" :class="{ 'gap-2': !collapsed }">
        <button type="button" @click="handleClick"
            class="d-flex align-items-center justify-content-between fw-bold gap-2 collapse-button" :class="{ collapsed }"
            data-toggle="collapse" :data-target="getHash" aria-expanded="false" :aria-controls="href + '-body'">
